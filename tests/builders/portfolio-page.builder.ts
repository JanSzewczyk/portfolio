...
type PortfolioTechnologyGroup = NonNullable<
  NonNullable<PortfolioPage["skills"]>["technologyGroups"]
>[number];
type PortfolioProjectGroup = NonNullable<
  NonNullable<PortfolioPage["projects"]>["projectGroups"]
>[number];
type PortfolioProject = NonNullable<
  NonNullable<PortfolioProjectGroup["projects"]>
>[number];
type PortfolioExperience = NonNullable<
  NonNullable<PortfolioPage["experience"]>["experiences"]
>[number];
type PortfolioEducation = NonNullable<
  NonNullable<PortfolioPage["education"]>["education"]
>[number];
type PortfolioTechnology = NonNullable<
  PortfolioTechnologyGroup["technologies"]
>[number];
 ...
 * });
 */
export const portfolioPageAboutBuilder = build<
  NonNullable<PortfolioPageQueryResult>["about"]
>({
  fields: {
    heading: {
 ...
 */
export const portfolioPagePersonalInfoBuilder = build<
  NonNullable<PortfolioPageQueryResult>["personalInfo"]
>({
  fields: {
 ...
 */
export const portfolioPageHeroBuilder = build<
  NonNullable<PortfolioPageQueryResult>["hero"]
>({
  fields: {
    alternativeTitles: () => [
 ...
 */
export const portfolioPageSkillsBuilder = build<
  NonNullable<PortfolioPageQueryResult>["skills"]
>({
  fields: {
    heading: {
      title: () => faker.lorem.words(3),
 ...
 */
export const portfolioPageProjectsBuilder = build<
...
export const experienceBuilder = build<PortfolioExperience>({
  fields: {
    ...
    responsibilities: () =>
      Array.from({ length: int(3, 6) }, () => faker.lorem.sentence()),
    achievements: () =>
      Array.from({ length: int(2, 4) }, () => faker.lorem.sentence()),
    technologies: () => technologyBuilder.many(int(3, 8)),
  },
  traits: {
    withoutLogo: {
 ...
 */
export const portfolioPageExperienceBuilder = build<
  NonNullable<PortfolioPageQueryResult>["experience"]
>({
  fields: {
    heading: {
      title: () => faker.lorem.words(3),
...
export const educationBuilder = build<PortfolioEducation>({
  fields: {
    ...
    achievements: () =>
      Array.from({ length: int(2, 4) }, () => faker.lorem.sentence()),
    coursework: () =>
      Array.from({ length: int(4, 8) }, () => faker.lorem.words(3)),
  },
});
 ...
 */
export const portfolioPageEducationBuilder = build<
  NonNullable<PortfolioPageQueryResult>["education"]
>({
  fields: {
    heading: {
 ...
 */
export const portfolioPageContactBuilder = build<
 ...
 */
export const portfolioPageSeoBuilder = build<
  NonNullable<PortfolioPageQueryResult>["seo"]
>({
  fields: {
    ...
    sameAsUrls: () =>
      Array.from({ length: int(1, 3) }, () => faker.internet.url()),
    alternateNames: () =>
      Array.from({ length: int(0, 2) }, () => faker.person.fullName()),
    addressLocality: () => faker.location.city(),
    addressCountry: () => faker.location.countryCode("alpha-2"),
    knowsAbout: () =>
      Array.from({ length: int(3, 6) }, () => faker.lorem.words(2)),
  },
  traits: {
    noSocial: {
      overrides: {
 ...
 */
export const portfolioPageFooterBuilder = build<
  NonNullable<PortfolioPageQueryResult>["footer"]
>({
  fields: {
 ...
 */
export const portfolioPageBuilder = build<
  NonNullable<PortfolioPageQueryResult>
>({
  fields: {
    _id: () => faker.string.uuid(),
